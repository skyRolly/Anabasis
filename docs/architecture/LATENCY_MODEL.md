...
**One call site** — `updateLatency()` (`src/PluginProcessor.cpp:492-510`, the only
...
| `prepareToPlay` | `src/PluginProcessor.cpp:462` |
| `setNonRealtime` | `src/PluginProcessor.cpp:482-489` |
...
deliberately redundant `updateLatency()` (`src/PluginProcessor.cpp:1318`) — belt-and-braces
