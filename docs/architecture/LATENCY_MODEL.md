...
**One call site** — `updateLatency()` (`src/PluginProcessor.cpp:517-535`, the only
...
| `prepareToPlay` | `src/PluginProcessor.cpp:487` |
| `setNonRealtime` | `src/PluginProcessor.cpp:507-514` |
