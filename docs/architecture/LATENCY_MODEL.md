...
**One call site** — `updateLatency()` (`src/PluginProcessor.cpp:449-467`, the only
...
| `prepareToPlay` | `src/PluginProcessor.cpp:419` |
| `setNonRealtime` | `src/PluginProcessor.cpp:439-446` |
...
deliberately redundant `updateLatency()` (`src/PluginProcessor.cpp:1275`) — belt-and-braces
