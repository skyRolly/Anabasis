...
| **0027**, **0038** | **0039** | **Pending — ADR-0039 is `Proposed`.** If Accepted it amends clause 4 and clause 8 BY EXCEPTION: their boundary stands for every site they cover, and one site is added where a mechanism supplies the consistency instead of an argument. Listed while pending so the widening is visible from the registry and not only from the row. |
