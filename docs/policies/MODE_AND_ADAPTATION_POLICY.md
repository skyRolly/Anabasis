...
(release ±1 octave, stereo link ±0.2, scHpf 0…+30 Hz — reaching the COMP's detector only since 0.1.2/ADR-0023, the limiter's being unfiltered — dynTilt 0…+0.5 dB), slewed at ~2 s with a
