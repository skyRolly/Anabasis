...
//
//  WHY THIS EXISTS. `TESTING_POLICY.md` rule 5: a checker must prove it is live
...
static void allocatingAudioCallback (int numSamples) noexcept ANABASIS_NONBLOCKING
{
